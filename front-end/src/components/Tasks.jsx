    ...
    <div className="heading sidehead mb-3">
     ...
     {dueTodayTasks.map((task) => (
                  <li key={task.id} className={`lss ${task.status === 'COMPLETED' ? 'done-list' : ''}`}>
                    {task.name}
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" type="button" onClick={() => deleteTask(task.id)} className="bi bi-trash trash me-3 pt-1" viewBox="0 0 16 16">
            ...
            <div className="col-sm" key={task.id}>
              <div className="p-1">
                <div
                  ...
                  style={{ height: '13rem', width: '16.9rem' }}
                >
